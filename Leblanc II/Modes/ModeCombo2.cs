...
//                            ObjectManager.Player.LSDistance(e.Position));
...
//                {
//                    if (!Target.HasImmortalBuff() && ObjectManager.Player.LSDistance(Target) < 650 &&
...
//            else
//            {
//                if (!Q.LSIsReady() && ActiveComboMode == ActiveComboMode.Mode2xQ  
...
//            fComboDamage += Q.LSIsReady() ? Q.GetDamage(t as AIHeroClient) * 2 : 0;
